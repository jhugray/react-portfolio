  ...
  return(
    <Container>    
      ...
      <Row style={{ width: 'auto', height: 'auto' }}>
        <Ratio>
          <iframe id="resume" src="https://docs.google.com/document/d/e/2PACX-1vS3q53FrjJN1HFwznNgPTDQvlHBKocuTYvKZ8nF1-s2i1apmY-FpEPQVho0dzG5zJE3Rzd1ndqXBeQO/pub?embedded=true"></iframe>
        </Ratio>
      </Row>
    </Container>
